# spec/controllers/api/v1/clubs_controller_spec.rb

require 'rails_helper'

RSpec.describe Api::V1::ClubsController do

  # Test if all clubs are returned on the index method 
  describe "GET #index" do
    ...
    it "JSON body response contains expected places attributes" do
      ...
      expect(json_response.keys).to match_array("clubs")
    end
